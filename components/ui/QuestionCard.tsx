      ...
      <div className="flex flex-col gap-3">
        {options.map((option) => (
          <button
            ...
            disabled={disabled}
            className={`w-full rounded-2xl border-2 px-6 py-4 text-left text-base font-medium transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60 ${
